...
# Inicializa e treina o modelo SVM
...
def save_scatter_plot(X_test, y_pred, output_dir="./out"):
    ...
    plt.title("Scatter Plot of SVM Predictions with PCA-reduced Test Data")
    plt.savefig(os.path.join(output_dir, "svm_scatter_plot.png"))
    plt.close()
    print(f"Scatter plot salvo em {output_dir}/svm_scatter_plot.png")
